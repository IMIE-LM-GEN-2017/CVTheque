...
class DocumentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session::flash('flash_message', 'Le CV a été ajouter avec succés!');
    ...
    public function update(Request $request, $id)
    {
        ...
        Session::flash('flash_message', 'Le CV a été mis à jour avec succés!');
    ...
    public function destroy($id)
    {
        ...
        Session::flash('flash_message', 'Le CV a été supprimer avec succés!');
